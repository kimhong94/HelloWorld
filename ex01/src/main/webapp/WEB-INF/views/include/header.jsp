    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>DATABASE</b> PROJECT</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/sboard/list"><i class="fa fa-circle-o"></i> 업로드 게시판</a></li>
                <li><a href="/resources/index2.html"><i class="fa fa-circle-o"></i> 게시판 v2</a></li>
              </ul>
            </li>
          </ul>
        </section>
